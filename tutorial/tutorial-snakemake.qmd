...
>>>>>>> 541b4a82d3f7475bb5e88014445030bf687a983c
...
En preparación para trabajar en el poryecto **Workflow-IIE** podría ser conveniente instalar [RaiDrive](https://www.raidrive.com/es/). Con esta herramienta montaremos un acceso al disco del equipo de Octavio, para que cada quien pueda trabajar desde la comodidad de y vea como un disco más los recursos necesarios del equipo de Octavio. Una vez que lo tengas instalado verán una pantalla de instalación. Elije la opción NAS/SFTP y apunta a la IP: 10.0.91.48 (aunque esta IP puede cambiar de vez en cuando al apagar el equipo).  El disco virtual que elijas será su punto de interconección para todo lo que sigue.
