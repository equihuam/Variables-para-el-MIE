...
En preparación para hacer esto podría ser conveniente instalar [RaiDrive](https://www.raidrive.com/es/). Con esta herramienta montaremos un acceso al disco del equipo de Octavio, para que desde sus equipos se vea como un disco más. Una vez que lo tengas instalado verán una pantalla de instalación. Elije la opción NAS/SFTP y apunta a la IP: 10.0.91.48 (aunque esta IP puede cambiar de vez en cuando al apagar el equipo).  El disco virtual que elijas será su punto de interconección para todo lo que sigue.

Instalé en el equipo de Octavio a **R** y **RStudio server** (en Linux no hay una aplicación de escritorio como la de Windows). Esto quiere decir que si te quieres ahorrar lo de RaiDrive, bien podrías hacer todo desde le browser. La forma de activar ese **RStudio** es poner en el browser la misma **IP** que te funcione para el **ssh** seguido de **:8787** y contesta lo que te pregunte. ¡Listo!, tendrás frente a ti todo lo necesario para operar el flujo de trabajo.

![http://10.0.91.48:8787](../img/rstudio.png)
