...
Al usar `$USER` los comandos substituirán esa variable automáticamente por el dato de quién inició la terminal (ej. `martha`, `octavio`, `maricruz` o `equihuam`). Lo hará en cualquier comando en el que aparecza.
...
En preparación para hacer esto será necesario instalar [RaiDrive](https://www.raidrive.com/es/). Con esta herramienta montaremos un acceso al disco del equipo de Octavio, para que desde sus equipos se vea como un disco más. Una vez que lo tengan instalado verán una pantalla de instalación. Elijan la opción NAS/SFTP y apunten a la ip: 10.0.90.182 (aunque esta ip puede cambiar de vez en cuando al apagar el equipo).  El disco virtual que elijan será su punto de interconexión para todo lo que sigue.

![Configurar RaiDrive](../img/RaiDrive.png)
