...
Validación rápida, básicamente se trata de averiguar si tienes un archivo bien armado (un qgz es una variante de contenedor zipeado), así puedes ver que no esté vacío. La otra, claro está, es abrirlo en qgis, pero si lo haces no lo guardes, para no alterar el proceso:
